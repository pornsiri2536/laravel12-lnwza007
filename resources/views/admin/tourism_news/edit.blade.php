...
@section('title','แก้ไขข่าวการท่องเที่ยว')
@section('page-title','แก้ไขข่าวการท่องเที่ยว (Edit)')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.tourism_news.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="image" value="{{ old('image', $item->image) }}" class="form-control @error('image') is-invalid @enderror" placeholder="/assets/img/news/01.jpg หรือ https://...">
